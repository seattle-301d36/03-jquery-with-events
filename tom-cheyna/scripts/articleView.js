...
articleView.handleAuthorFilter = function() {
  $('#author-filter').on('change', function() {
    ...
    if ($(this).val()) {
      ...
      $(`article[data-author="${authorNameData}"]`).fadeIn();
      ...
      $('#articles').find('.template').siblings().fadeIn();
    }
    $('#category-filter').val('');
  });
};
...
articleView.handleCategoryFilter = function() {
  ...
  $('#category-filter').on('change', function() {
    ...
    if ($(this).val()) {
      ...
      $(`article[data-category="${categoryNameData}"]`).fadeIn();
...
articleView.handleMainNav = function() {
  ...
  $('li[data-content="articles"]').on('click', function() {
    $('.tab-content').hide();
    $('#articles').fadeIn();
  });
